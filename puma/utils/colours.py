"""Helper functions for good colours and linestyles."""
...
def get_good_pie_colours(colour_scheme: str | None = None) -> list[str]:
...
def get_good_colours(colour_scheme: str | None = None) -> list[str]:
...
def get_good_linestyles(names: list | str | None = None) -> list | Any:
