...
The `puma:latest` image is based on `python:3.11` and is meant for users who want to use the latest version of `puma`. For each release, there is a corresponding tagged image.
